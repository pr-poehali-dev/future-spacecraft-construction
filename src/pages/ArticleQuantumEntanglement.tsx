          ...
          <div className="prose prose-lg max-w-none">
            <Card className="glow-card mb-8">
              <CardContent className="pt-6">
                ...
                <h2 className="text-3xl font-bold mb-4 mt-8">Что такое квантовая запутанность?</h2>
                <p className="text-lg leading-relaxed mb-6">
                ...
                <h2 className="text-3xl font-bold mb-4 mt-8">Применение в космонавтике</h2>
                <p className="text-lg leading-relaxed mb-6">
                ...
                <h2 className="text-3xl font-bold mb-4 mt-8">Прорыв в лаборатории</h2>
                <p className="text-lg leading-relaxed mb-6">
                ...
                <h2 className="text-3xl font-bold mb-4 mt-8">Технические вызовы</h2>
                <p className="text-lg leading-relaxed mb-6">
                ...
                <h2 className="text-3xl font-bold mb-4 mt-8">Перспективы и сроки</h2>
                <p className="text-lg leading-relaxed mb-6">
