  ...
  return (
    <div className="min-h-screen">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 p-4 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full shadow-lg glow-card transition-all duration-300 hover:scale-110 z-50"
